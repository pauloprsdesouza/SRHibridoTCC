...
public abstract class AbstractDataModel extends Configured implements DataModel {
     ...
     */
    protected void buildSplitter() throws LibrecException {// separa os dados entre treinamentos e teste
        String splitter = conf.get("data.model.splitter");
        System.out.println("splitter: "+splitter);
        try {System.out.println("driver: "+DriverClassUtil.getClass(splitter));
    ...
    protected void buildFeature() throws LibrecException {
        ...
        if (StringUtils.isNotBlank(feature)) {
            try {System.out.println("DriverClassUtil.getClass(feature): "+DriverClassUtil.getClass(feature));
