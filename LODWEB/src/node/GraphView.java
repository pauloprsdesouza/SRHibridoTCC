...
public class GraphView extends Display {
    ...
    public static final String DATA_FILE = "lodica.xml";
    ...
    public GraphView(Graph g, String label) {
        ...
        fonts.add("ingroup('_focus_')", FontLib.getFont("Tahoma", 14));
    ...
    public static void main(String argv[]) {
        ...
        JFrame frame = new JFrame("L O D I C A | DEREK AND FRED");
    ...
    public static JPanel demo(Graph g, final String label) {        
        ...
        final GraphView gview = new GraphView(g, label);
